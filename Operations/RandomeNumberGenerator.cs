...
{ 
    ...
    public class RandomeNumberGenerator
    {
        ...
        public static double GetUniform(double max)
        {
            ...
            double randomSpeed = max * rand; // between 0-max.
            return randomSpeed;
        }

        /// <summary>
        /// randome speed between min and max.
        /// </summary>
        ...
        public static double GetNormal()
        {
            ...
            double q = GetUniform();
            double p = GetUniform();
            double r = Math.Sqrt(-2.0 * Math.Log(q));
        ...
        public static double GetNormal(double mean, double standardDeviation)
        {
            ...
            double nor= GetNormal();
            double re = mean + standardDeviation * nor;
            return re;
        }
